...
export const MurabahaForm = () => {
  ...
  const handleDownloadPdf = async () => {
    ...
    pdf.addImage(data, "PNG", 5, 10, 200, 270, undefined, "FAST");
    pdf.save("murabaha.pdf");
    //pdf.addHTML("#murabahaPDF"[0], function () {
    //  pdf.save("murabaha.pdf");
    //});
  };
      ...
      <div ref={printRef} id="murabahaPDF">
        ...
        <Container className="mrbaha-form-container">
          ...
          <Row xs={2} md={2} className="g-4 mrbaha-form mt-2">
            <Col>
              <h5 className="text-center fw-bold mb-3">BETWEEN</h5>
              <Form>
              ...
              <p>
                ...
                shall where the context so permits mean and include its
                successors in interest and permitted assigns) of the ONE PART
              </p>
            </Col>

            <Col>
              <h5 className="text-center fw-bold mb-3">AND</h5>
              <Form>
                <Form.Group className="mb-3" controlId="formBasicEmail">
                  <Form.Label>Mr / Messrs*: &nbsp;</Form.Label>
                  <Form.Control type="text" />
              ...
              <p>
                ...
                expression shall where the context so permits mean and include
                its successors in interest and assigns) of the OTHER PART.
              </p>
            </Col>
          </Row>
          {/*2. Object of the Murabaha Agreement*/}
          <Row xs={1} md={1} className="g-4 mrbaha-form mt-1">
            <div className="mrbaha-section-serial mb-2">
              ...
              <ul>
                <li>
                  The Second Party agrees to sell the Goods to the First Party
                  ...
                  from the Second Party at the Contract Price. Upon receipt by
                  the Second Party of the First Party's Purchase Requisition
                  advising the Second Party to purchase the Goods and making
                  payment therefore, the Second Party shall acquire the Goods
                  either directly or through the Agent. The payment for such
                  goods shall be made by the Second Party on submission of
                  Purchase Advice by the client/agent.
                </li>
                <li className="mt-4">
                  Upon receipt of purchase of Goods by the Second Party,
                  directly or through an Agent, from the Supplier, the Goods
                  shall be at the risk and cost of the Second Party until such
                  time that these Goods are sold to the First Party.{" "}
                </li>
                <li className="mt-4">
                  The First Party’s purchase of Goods from the Second Party
                  shall be affected by the exchange of an offer and acceptance
                  between the First Party and the Second Party as stipulated in
                  the Declaration.{" "}
                </li>
              </ul>
            </div>
          ...
          <Row xs={1} md={2} className="g-4 mrbaha-form">
            <Col>
              <h4 className="fw-normal mb-4">3. Terms and Condition</h4>
              <div className="mrbaha-section-serial">
                <h5 className="fw-normal mb-5">
                  (i) Payment of Contract Price
                </h5>
                ...
                <p>
                  ...
                  Agreement shall be made in full, without any set-off, roll
                  over or counterclaim whatsoever, on the due date and when the
                  due date is not a Business Day, the following Business Day.{" "}
                </p>
              </div>
            </Col>
              ...
              <div className="mrbaha-section-serial mb-5">
                ...
                <p className="mb-4">
                  ...
                  <span className="ms-5">
                    ...
                    or repeated by the First Party in or pursuant to the
                ...
                <p>
                  ...
                  First Party declare that entire amount by which the First
                  Party is indebted to the Second Party shall forthwith become
                  due and payable.
                </p>
              </div>
            </Col>
          </Row>
          <Row xs={1} md={2} className="mt-3 mrbaha-form">
            <Col>
              <p>
