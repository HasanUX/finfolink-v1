...
import "../../css/benefits/benefits.css";
  ...
  return (
    <Container className="benefit-container">
      ...
      <Row
        xs={1}
        md={3}
        className="g-4 justify-content-center align-items-center benefit-row"
      >
        <Col>
          <h3 className="benefit-title">
            You and your business partner will get benefitted because we have
            ⎯⎯⎯
          </h3>
        </Col>
